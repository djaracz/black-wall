...
export namespace ApiService {
  ...
  export type Create = {
    ...
    post: <Entry>(params?: string, data?: any, config?: AxiosRequestConfig) => (message: string) => () => Promise<Entry>,
    put: <Entry>(params?: string, data?: any, config?: AxiosRequestConfig) => (message: string) => () => Promise<Entry>,
    delete: <Entry>(params?: string, config?: AxiosRequestConfig) => (message: string) => () => Promise<Entry>,
  }
  export function create (
    ...
    return {
      ...
      post: <Entry>(params: string = '', data: any = {}, config: AxiosRequestConfig = {}) => (message: string) => () =>
        postDumb<Entry>(
          `${baseUrl}/${params}`,
          data,
          config,
      ...
      put: <Entry>(params: string = '', data: any = {}, config: AxiosRequestConfig = {}) => (message: string) => () =>
        putDumb<Entry>(
          `${baseUrl}/${params}`,
          data,
          config,
      ...
      delete: <Entry>(params: string = '', config: AxiosRequestConfig = {}) => (message: string) => () =>
        deleteDumb<Entry>(
          `${baseUrl}/${params}`,
          config,
          instance
